...
const SignUp = () => {
  ...
  return (
    <div className=" font-roboto  relative  ">
      ...
      <div className="signUp_container flex  justify-between pr-[106px] pl-[124px] pt-[90px]  flex-wrap items-center z-10	max-xl:justify-center max-xl:items-center  max-xl:pr-[0px] max-xl:pl-[0px] max-xl:pt-[100px]">
